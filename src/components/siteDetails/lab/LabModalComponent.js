...
const LabModal = ({ open, setOpen, isAddButton, editData, locationId, branchId, facilityId, buildingId, floorId, setRefreshData, img }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (isAddButton) {
      await LabAddService({ labDepName, labDepMap, labDepMap, labCords, location_id, branch_id, facility_id, building_id, floor_id }, handleSuccess, handleException);
    } else {
      await LabEditService({ labDepName, labDepMap, labDepMap, labCords, location_id, branch_id, facility_id, building_id, floor_id, labid }, handleSuccess, handleException);
    }
  };
