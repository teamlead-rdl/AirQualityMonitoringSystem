...
const ImageMarkerComponent = (props) => {
  let { setFloorCoordinations, floorCords, setLabCords } = props;
  ...
  useState(()=>{
    let coordinates = floorCords ? JSON.parse(floorCords): [];
  ...
  const CustomMarker2 = (props) => {
    return (
      <img src={imgShape} alt="Pointer" width="100" height="100"></img>
      // <img src={floorPointer} alt="Pointer" width="20" height="20"></img>
    );
  };
  const CustomMarker3 = (props) => {
    return (
      <img src={cctvShape} alt="Pointer" width="100" height="100"></img>
      // <img src={floorPointer} alt="Pointer" width="20" height="20"></img>
    );
  };
  return (
