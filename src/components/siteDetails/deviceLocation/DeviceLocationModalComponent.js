import { Button, Dialog, DialogContent, DialogTitle, TextField , Box, Grid, Autocomplete} from '@mui/material'
...
const DeviceLocationModal = ({open, setOpen, isAddButton, locationData, categoryList}) => {
    ...
    const handleSubmit = async (e) =>{
        e.preventDefault();
        if (isAddButton) {
                    AddDeviceLocationService({location_id, branch_id, facility_id, building_id, floor_id, lab_id, device_id, categoryName, deviceName, category_id, description, assetTag, macAddress, floorCords, deviceIcon}, handleSuccess, handleException);
            } else {
                EditDeviceLocationService({location_id, branch_id, facility_id, building_id, floor_id, lab_id, device_id, categoryName, deviceName, category_id, description, assetTag, macAddress, floorCords, deviceIcon, devicelocationId}, handleSuccess, handleException);
            }
        setOpen(false);
        setErrorObject({});
                    ...
                    <div className="mx-auto outline-black">
                        <div className="inline">
                            ...
                            <div className="w-full sm:float-right lg:float-left lg:w-4/6 pr-1">
                                <div style={{width:100+'%', height:60+'vh',borderColor:'black', border: 2+'px'+' solid'+' black'}}>
                                <Box
                                    sx={{
                                    }}
                                    >
