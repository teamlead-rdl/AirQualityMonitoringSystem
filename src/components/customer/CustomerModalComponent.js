...
const CustomerModal = ({open, setOpen, isAddButton, customerData, setRefreshData}) => {
  ...
  const handleSubmit = async (e) =>{
    e.preventDefault();
    if(isAddButton){
      await CustomerAddService({customerName, email, phoneNo, address, customerId, customerLogo, customerTheme}, handleSuccess, handleException);
    }
    else{
      await CustomerEditService({id, customerName, email, phoneNo, address, customerId, customerLogo, customerTheme}, handleSuccess, handleException);
    }
  };
