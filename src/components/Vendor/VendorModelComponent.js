...
const VendorModel = ({open, setOpen, isAddButton, vendorData, setRefreshData}) => {
  ...
  const handleSubmit = async (e) =>{
    ...
    // -- API call -- //
    if(isAddButton){
      await VendorAddService({vendorName, phoneNumber, emailId, address, contactPerson}, handleSuccess, handleException);
    }
    else{
      await VendorEditService({id, vendorName, phoneNumber, emailId, address, contactPerson}, handleSuccess, handleException);
    }
  };
